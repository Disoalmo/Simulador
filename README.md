...
Un sitio web frontend en React para permitir simular inversiones con uso de dinero virtual, pero con datos de la bolsa reales (empresas, precios y graficas). Permite realizar venta y compra de acciones, inversión en bonos o EFT´s y manejar una carpeta de inversión. Construida con React, JavaScript y Vite para un rendimiento óptimo.

**Repositorio:** https://github.com/Disoalmo/Simulador.git
### Características
...
- **UI Profesional** - Interfaz limpia y confiable con temática financiera
